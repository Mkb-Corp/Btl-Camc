                                ...
                                <div class="card">
                                    <div class="card-body p-6">
                                        <form action="{{ route('payment_validation') }}" method="post">
                                                                    ...
                                                                    <tr>
                                                                        <td class="table-td">
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    class="inline-flex items-center cursor-pointer checkbox">
                                            ...
                                            <button type="submit" class="btn btn-success inline-flex justify-center bg-slate-900 text-slate-50 dark:bg-slate-900 dark:text-slate-300">Valider</button>
